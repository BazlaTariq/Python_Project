...
def most_successful (df, sport): #The function will be given the data frame and the value of sport and will tell the most successful athlete in that sport
...
def year_wise_medal_tally(df, country):
    ...
    new_df = temp_df[temp_df['region'] == country]  # TO find the medal-count of a particular country over years
